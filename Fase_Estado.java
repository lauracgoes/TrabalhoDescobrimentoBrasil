 ...
 * @author Flavio
 */
public class Fase_Estado extends Estado{
    ...
    Fase_Estado () throws IOException{
    ...
    public void Carrega_Pontuacao(Pontuacao a){
       ...
       Pontos = a;
        ...
        private void Carrega_Mapa(){
            ...
            Carrega_Mapa_Aqui("Rio de Janeiro", "Norte");
            Carrega_Mapa_Aqui("Acre", "Norte");
        ...
        private void Carrega_Mapa() throws IOException {// mudanca ocorreu aqui
           ...
           for(int i = 1; i <= BaseD.TamanhoArq("Cidade") ; i++){
                aux = BaseD.RetornaBase(i,"Cidade");
    ...
    int controlaLoop =0,tamanhoLista=0 ;    
    String regiao,cidade;
  
       System.out.println("-------------------------- Fase 3 ----------------------");// trocar com fase 2
       System.out.println("Regras da Fase:");
       System.out.println("O jogador tem que selecionar um Estado e dizer a qual e sua Sigla corespondente.");
       System.out.println("Acertos de Primeira: 2 pontos  \\ Acertos com mais de uma tentativa: 1 ponto");
       
       tamanhoLista=Retorna_Tamanho_Lista();
       ...
       while(controlaLoop < tamanhoLista){
        ...
        System.out.println("Digite a Sigla correspondente:  ");
        regiao = Seta_Texto();
      
        
        if(Verifica_Contain_Sigla(cidade,regiao) == true){
             if(Verifica_Se_Palavra_Escolhida(cidade) == false){
                
                Remove_String(cidade);
                controlaLoop++;
                Pontos.Incrementa_Pontuacao();
                Insere_Palavra(cidade);
